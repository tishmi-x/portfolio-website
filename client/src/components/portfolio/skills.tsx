...
import { Code2, Globe, BrainCircuit } from "lucide-react";
...
const skills = [
  {
    ...
    description:
      "Building logic and foundational understanding of computational thinking.",
  },
  {
    category: "Web",
    icon: <Globe className="w-8 h-8 text-accent" />,
    items: ["HTML (Basic)", "CSS (Basic)"],
  ...
  },
  {
    ...
    description:
      "Sharpening the mind to tackle complex algorithmic challenges.",
  },
];
